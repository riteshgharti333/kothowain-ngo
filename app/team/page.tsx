...
const TeamBadge = ({ name = "Team Member", role = "Role" }: { name?: string; role?: string }) => (
...
const TeamPage = () => {
  ...
  const advisoryBoard = [
    {
      ...
      image: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400&h=500&fit=crop&q=80",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=400&h=500&fit=crop&q=80",
  ...
  const teamSections = [
    { id: "leadership", label: "Leadership", icon: FiStar, count: leadershipTeam.length },
    { id: "field", label: "Field Team", icon: FiMapPin, count: fieldTeam.length },
    { id: "advisory", label: "Advisory Board", icon: FiAward, count: advisoryBoard.length },
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="max-w-[1100px] mx-auto px-6 lg:px-10">
          <div className="text-center mb-14">
            ...
            <p className="text-ink-soft text-sm mt-4 max-w-[500px] mx-auto">
              Our work is strengthened by partnerships with community organizations, local groups, and volunteer teams.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[480px]">
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=800&h=900&fit=crop&q=80"
          ...
          >
            ...
            <span className="font-mono text-xs tracking-[0.25em] uppercase text-amber-500 font-bold mb-5 inline-flex items-center gap-2">
              <FiUserPlus className="w-4 h-4" /> Join our team
            </span>

            <h2 className="font-display font-semibold text-4xl lg:text-5xl text-cream-50 leading-[1.05] tracking-tight mb-4">
              Want to be{" "}
              <span className="text-amber-500 italic font-normal">part of this?</span>
            </h2>
            ...
            <p className="text-cream-50/70 text-lg max-w-[420px] leading-relaxed mb-8">
              ...
              difference. Whether you're in Dhaka, Bandarban, or anywhere in
              the world — there's a place for you here.
            </p>
