...
const FoodPage = () => {
  ...
  const menu = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1626200926749-1b25d3f97fa6?w=600&h=450&fit=crop&q=80",
    },
    {
      icon: FiUsers,
      tag: "Daily",
  ...
  const tiffinTiers = [
    { tier: "1", title: "Source", desc: "Local farms and grain stores across the Hill Districts.", icon: FiSun, side: "left" },
    { tier: "2", title: "Kitchen", desc: "Community kitchens cook and portion each week's supply.", icon: FiHome, side: "right" },
    { tier: "3", title: "Center", desc: "Learning centers and clinics distribute to families on-site.", icon: FiUsers, side: "left" },
    { tier: "4", title: "Table", desc: "A hot meal reaches the family table before it goes cold.", icon: FiHeart, side: "right" },
  ];

  const plateStats = [
    { label: "Meals Served", value: "1.1M+", color: "bg-amber-500", icon: FiPackage },
    { label: "Water Access", value: "94%", color: "bg-teal-700", icon: FiDroplet },
    { label: "Malnutrition Drop", value: "31%", color: "bg-amber-400", icon: FiHeart },
    { label: "Kitchens Running", value: "38", color: "bg-teal-950", icon: FiHome },
  ];

  const seasons = [
    { month: "Boishakh", season: "Spring Harvest", desc: "Early vegetables and seed distribution begin.", image: "https://images.unsplash.com/photo-1592419044706-39796d40f98c?w=400&h=500&fit=crop&q=80" },
    { month: "Ashar", season: "Monsoon Planting", desc: "Rice paddies planted; kitchen gardens expand.", image: "https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?w=400&h=500&fit=crop&q=80" },
    { month: "Ashwin", season: "Lean Season", desc: "Nutrition packages scale up before the harvest gap.", image: "https://images.unsplash.com/photo-1626200926749-1b25d3f97fa6?w=400&h=500&fit=crop&q=80" },
    { month: "Poush", season: "Winter Harvest", desc: "Main rice harvest; community kitchens run full.", image: "https://images.unsplash.com/photo-1571680322279-a226e6a4cc2a?w=400&h=500&fit=crop&q=80" },
  ];
  ...
  return (
    <main className="">
      ...
      {/* ============================================================ */}
      <PageBanner
        image="https://images.unsplash.com/photo-1547592180-85f173990554?w=1600&h=900&fit=crop&q=80"
        breadcrumb="Food & Nutrition"
        headingLine1="No Family"
        headingHighlight="Goes Hungry."
        headingLine2="No Harvest"
        headingAfter="Goes to Waste."
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <HeadingWithPaint text="A pantry that never sits empty" className="text-left mb-6" />
              <p className="text-ink-soft leading-[1.85] text-base mb-4">
                In the Chittagong Hill Tracts, the gap between one harvest and
                the next is when families go without. Kothowain works the
                whole chain — seed, soil, storage, and stove — so that gap
                closes a little more each year.
              </p>
              <p className="text-ink-soft leading-[1.85] text-base mb-8">
                Kitchen gardens grow the everyday vegetables. Community
                kitchens turn shared grain into shared meals. And when the
                season runs short, nutrition packages carry families
                through.
              </p>
              <div className="flex flex-wrap gap-3">
                {["Kitchen Gardens", "Community Kitchens", "Nutrition Packages", "School Feeding"].map((tag) => (
                  <span
                    key={tag}
      ...
      <section className="py-[90px] lg:py-[120px] bg-paper">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <div className="text-center mb-16">
            ...
            <HeadingWithPaint text="What we put on the table" className="justify-center" />
          </div>
            ...
            <div className="pt-16 sm:pt-20 space-y-4">
              {tiffinTiers.map((tier, index) => (
                <motion.button
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  className={`w-full flex items-center gap-5 rounded-full pl-3 pr-6 py-3 transition-all duration-300 text-left ${
                    activeTier === index
                ...
                >
                  <span
                    className={`w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0 font-display font-bold text-lg transition-colors duration-300 ${
                      activeTier === index ? "bg-amber-500 text-teal-950" : "bg-teal-900 text-amber-400"
                    }`}
                  >
                  ...
                  <span className="flex-1 min-w-0">
                    <span
                      className={`block font-mono text-[10px] tracking-widest font-bold ${
                        activeTier === index ? "text-amber-600" : "text-amber-400/70"
                      }`}
                    >
                      TIN {tier.tier}
                    </span>
                    ...
                    <span
                      className={`block text-sm mt-0.5 ${
                        activeTier === index ? "text-ink-soft" : "text-cream-50/50"
                      }`}
                    >
                      {tier.desc}
                    </span>
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <HeadingWithPaint text="Impact, served in one sitting" className="text-left mb-6" />
              <p className="text-ink-soft leading-[1.85] text-base mb-4">
                Every wedge of this plate is a program working at once —
                meals served, clean water reaching kitchens, malnutrition
                falling, and community kitchens staying lit through the lean
                months.
              </p>
              <p className="text-ink-soft leading-[1.85] text-base">
                None of the four works alone. A meal without clean water
                isn't a full plate, and neither is one without a kitchen to
                cook it in.
              </p>
            </div>
          </div>
      ...
      <section className="py-[90px] lg:py-[120px] bg-paper">
        <div className="max-w-[1000px] mx-auto px-6 lg:px-10">
          <div className="text-center mb-14">
            ...
            <HeadingWithPaint text="Meet a community cook" className="justify-center" />
          </div>
          ...
          >
            <div className="relative aspect-[4/5] lg:aspect-auto">
              <Image
                src="https://images.unsplash.com/photo-1583394838336-acd977736f90?w=600&h=750&fit=crop&q=80"
            ...
            <div className="p-8 lg:p-11">
              ...
              <p className="text-ink-soft text-sm leading-relaxed mb-5">
                ...
                whatever the community pools together — rice, greens, dried
                fish — into a meal that stretches the furthest.
              </p>
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-3 mb-6 border-t border-b border-dashed border-teal-950/15 py-5">
                <div>
                  ...
                  <span className="text-teal-950 font-semibold text-sm">40 families / week</span>
                </div>
                <div>
                  <span className="block text-[10px] uppercase tracking-wide text-ink-soft font-bold mb-1">
                    Cooking since
                  </span>
                  <span className="text-teal-950 font-semibold text-sm">2016</span>
                </div>
                <div>
                  <span className="block text-[10px] uppercase tracking-wide text-ink-soft font-bold mb-1">
                    Specialty
                  </span>
                  <span className="text-teal-950 font-semibold text-sm">Stretch-rice stews</span>
                </div>
                <div>
                  <span className="block text-[10px] uppercase tracking-wide text-ink-soft font-bold mb-1">
                    Trained
                  </span>
                  <span className="text-teal-950 font-semibold text-sm">6 new cooks</span>
                </div>
              </div>
              ...
              <div className="bg-cream-50 rounded-2xl p-5 border-l-4 border-amber-500">
                <p className="text-teal-950 text-sm italic leading-relaxed">
                  "Nobody eats better than anyone else at my table. That's
                  the whole recipe."
                </p>
              </div>
            </div>
      ...
      {/* ============================================================ */}
      {/* 7. HARVEST CALENDAR — horizontal season ribbon                 */}
      {/* ============================================================ */}
      <section className="py-[90px] lg:py-[120px] bg-cream-100 overflow-hidden">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <div className="text-center mb-14">
            <div className="flex items-center justify-center gap-3 mb-6">
              <span className="w-8 h-[2px] bg-amber-500 rounded-full" />
            ...
            <HeadingWithPaint text="The harvest calendar" className="justify-center" />
          </div>
        </div>

        <div className="flex gap-5 overflow-x-auto px-6 lg:px-10 pb-6 snap-x snap-mandatory scrollbar-hide max-w-[1280px] mx-auto">
          {seasons.map((season, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: index * 0.1 }}
              className="group relative flex-shrink-0 w-[220px] aspect-[3/4] rounded-2xl overflow-hidden shadow-lg snap-start"
            >
              <Image
                src={season.image}
                alt={season.season}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <h3 className="font-display text-lg text-cream-50 font-semibold mt-1 mb-1.5">
                  {season.season}
                </h3>
                <p className="text-cream-50/70 text-xs leading-relaxed">{season.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <section className="py-[90px] lg:py-[120px] bg-paper">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-10">
          <div className="text-center mb-14">
            ...
            <HeadingWithPaint text="Our market partners" className="justify-center" />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[480px]">
          ...
          >
            ...
            <p className="text-cream-50/70 text-lg max-w-[420px] leading-relaxed mb-8">
              One gift funds one week of meals for one community kitchen.
              Pull up a chair.
            </p>
